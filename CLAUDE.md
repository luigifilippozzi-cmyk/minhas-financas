...
npm test                    # Vitest — roda suite de 470 testes unitários
...
- **470 testes unitários** cobrindo: parsers, dedup, ajusteDetector, normalizador, pipelineCartao, importarDedup, detectorTransferenciaInterna, reconciliadorFatura, bankFingerprintMap, detectorOrigemArquivo, recurringDetector, pdfParser
...
## Estado Atual do Projeto (2026-04-13) — v3.23.3
...
npm test                    # 470 testes devem passar
