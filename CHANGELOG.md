...
## [Unreleased]
### Adicionado
- **feat(importar): Tipo de transa��o no seletor de categoria do preview banc�rio (RF-063/RF-064):** o seletor de categoria no preview de importa��o banc�ria agora exibe o tipo de transa��o detectado (receita/despesa/transfer�ncia), permitindo ao usu�rio validar a classifica��o antes de confirmar a importa��o banc�ria. Implementado em `importar.js` (86 inser��es, 4 altera��es). Testes: 514 passando.
## [3.23.8] - 2026-04-14
